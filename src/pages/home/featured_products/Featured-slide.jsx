...
export default function FeaturedSlide({ item }) {
  ...
  return (
    <div className="group z-10 mx-auto my-0 mb-10 mt-8 flex h-[69%] w-fit flex-col items-center justify-center rounded-md pb-4 shadow-xl transition-all hover:-translate-y-4 hover:shadow-2xl">
